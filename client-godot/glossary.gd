...
const KW := {
	...
	"floodlight": "Прожектор: пока в игре, вы видите личности вражеских кристаллов-заготовок.",
	"delay": "Отсрочка N: эффект срабатывает в начале вашего хода через N ход(ов).",
	"decoy": "Подготовка N: пролежав N ваших ходов в мана-ряду, разбуживается без доплаты — расходуется только её собственный кристалл.",
	"spectral_shift": "Спектральный сдвиг: раз в ход один кристалл можно потратить как соседний по спектру цвет (К-Ж-З-С-Ф).",
	...
	"facet": "Огранка: вы можете будить (awaken) любую свою карту из мана-ряда, а не только awaken-карты; разбуженные существа выходят с +1/+1.",
