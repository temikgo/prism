...
const KW := {
	...
	"decoy": "Подготовка N: пролежав N ваших ходов в мана-ряду, разбуживается бесплатно (тратится только её кристалл).",
	"spectral_shift": "Спектральный сдвиг: раз в ход один кристалл можно потратить как соседний по спектру цвет (К-Ж-З-С-Ф).",
	"umbra": "Полумрак: существа, атакующие вашего героя, наносят ему на 1 меньше.",
	"clairvoyance": "Прозрение: вы всегда видите верхнюю карту своей колоды.",
}
